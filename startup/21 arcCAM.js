...
moi.ui.commandBar.CommandBarCustomUI.insertAdjacentHTML( "beforeEnd", '<moi:Spacer/><moi:CommandButton icon="icons/PocketOffsetIcon.png" command="PocketOffset">PocketOffset</moi:/andButton>');
