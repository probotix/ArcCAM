...
moi.ui.commandBar.CommandBarCustomUI.insertAdjacentHTML( "beforeEnd", '<moi:Spacer/><moi:CommandButton icon="icons/FixCirclesIcon.png" command="SetCircles">SetCircles</moi:/andButton>');
moi.ui.commandBar.CommandBarCustomUI.insertAdjacentHTML( "beforeEnd", '<moi:Spacer/><moi:CommandButton icon="icons/FixCirclesIcon.png" command="RepairCircles">RepairCircles</moi:/andButton>');
